...
async function automateLogin(accountName, url) {
...
// 读取账号文件并执行登录
(async () => {
    const accountNames = ['15977338187','17878136640']; // 指定要使用的多个账号名称 15977338187
    ...
    const loginPromises = accountNames.map(accountName => automateLogin(accountName, url));
